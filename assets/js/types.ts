...
export type event =
    ...
    { m: EventName.entity_animated_to, p: { entity_id: string, pos?: number[], rot?: number[], duration: number }, ts?: number } |
    ...
    { m: EventName.agent_attacked_member, p: { name: string, member_id: string } } |
