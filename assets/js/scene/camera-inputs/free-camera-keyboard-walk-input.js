...
exports.FreeCameraKeyboardWalkInput = void 0;
 ...
 */
var FreeCameraKeyboardWalkInput = /** @class */ (function () {
    function FreeCameraKeyboardWalkInput() {
        /**
         * Gets or Set the list of keyboard keys used to control the forward move of the camera.
         */
        this.keysForward = [38, 87];
        /**
         ...
         */
        this.keysRight = [68];
        this.keysRotateLeft = [37, 81];
        this.keysRotateRight = [39, 69];
        this.rotationSpeed = 2;
        this._keys = new Array();
    }
    FreeCameraKeyboardWalkInput.prototype.myKeysMatched = function (keyCode) {
     ...
     */
    FreeCameraKeyboardWalkInput.prototype.detachControl = function (ignored) {
        if (this._scene) {
    ...
    /** @hidden */
    FreeCameraKeyboardWalkInput.prototype._onLostFocus = function () {
        this._keys = [];
    };
    /**
    ...
    FreeCameraKeyboardWalkInput.prototype._getLocalRotation = function () {
...
exports.FreeCameraKeyboardWalkInput = FreeCameraKeyboardWalkInput;
BABYLON.CameraInputTypes["FreeCameraKeyboardWalkInput"] = FreeCameraKeyboardWalkInput;
