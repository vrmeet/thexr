...
defmodule EventName do
  ...
  def int_to_atom(2201), do: :entity_created
  ...
  def int_to_atom(4060), do: :entity_animated_to
  ...
  def int_to_atom(5030), do: :entity_collected
  ...
  def int_to_atom(7400), do: :agent_attacked_member
  ...
  def atom_to_int(:entity_animated_to), do: 4060
  ...
  def atom_to_int(:entity_collected), do: 5030
  ...
  def atom_to_int(:agent_attacked_member), do: 7400
