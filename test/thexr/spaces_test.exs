defmodule Thexr.SpacesTest do
  ...
  #   test "saving components on an entity" do
  #     space = space_fixture()

  #     {:ok, entity} =
  #       Spaces.create_entity(%{
  #         "type" => "box",
  #         "space_id" => space.id
  #       })
  ...
  #     assert length(entity.components) == 3
  #     # entity = entity_fixture()

  #     # Spaces.create_component_for_entity(entity.id, "position", %{
  #     #   "x" => 1.1,
  #     #   "y" => 2.2,
  #     #   "z" => 3.3
  #     # })
  ...
  #     valid_attrs = Map.put(valid_attrs, :components, %{position: %{x: 0, y: 1, z: -2}})
